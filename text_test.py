...
def test():
    ...
    feed_dict = {
        ...
        model.keep_prob:1,
        model.seq_length: get_sequence_length(x_test)
        }
    ...
    for i in range(num_batch):
        ...
        feed_dict={
            ...
            model.keep_prob:1.0,
            model.seq_length: get_sequence_length(x_test[start_id:end_id])
        }
        y_pred_cls[start_id:end_id]=session.run(model.predict,feed_dict=feed_dict)
